...
def test_fix1dmw():
    ...
    hnf, err = pygram11.fix1dmw(x, w, bins=nbins, range=(xmin, xmax), flow=False,)
    hh, err = pygram11.fix1dmw(x, w, bins=nbins, range=(xmin, xmax), flow=True,)
...
def test_var1dmw():
    ...
    hnf, err = pygram11.var1dmw(x, w, bins=bins, flow=False,)
    hh, err = pygram11.var1dmw(x, w, bins=bins, flow=True,)
    for i in range(hh.shape[1]):
...
def test_flow_weights():
    ...
    nbins = 50
    rg = (-3, 3)
    pygram_h, __ = pygram11.histogram(x, bins=nbins, range=rg, weights=w, flow=True)
...
def test_flow():
    ...
    nbins = 50
    rg = (-3, 3)
    pygram_h, __ = pygram11.histogram(x, bins=nbins, range=rg, flow=True)
...
def test_flow_var():
    ...
    pygram_h, __ = pygram11.histogram(x, bins=bins, flow=True)
    numpy_h, __ = np.histogram(x, bins=bins)
...
def test_flow_weights_var():
    ...
    w = np.random.uniform(0.5, 0.8, x.shape[0])
    bins = [-2, -1.7, -0.5, 0.2, 2.2]
    pygram_h, __ = pygram11.histogram(x, bins=bins, weights=w, flow=True)
    numpy_h, __ = np.histogram(x, bins=bins, weights=w)
